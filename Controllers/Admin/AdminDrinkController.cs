...
namespace TrklPPR
{
    public class AdminDrinkController : Controller
    {
        ...
        public AdminDrinkController(TrklPPRContext context)
        {
            _context = context;
        }
        ...
        // GET: AdminDrink/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: AdminDrink/Create
