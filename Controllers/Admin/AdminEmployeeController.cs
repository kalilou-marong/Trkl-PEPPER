...
namespace TrklPPR
{
    public class AdminEmployeeController : Controller
    {
        ...
        public AdminEmployeeController(TrklPPRContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,PathImg,Role,HireDate")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,PathImg,Role,HireDate")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
